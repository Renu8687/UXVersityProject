                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="float-right mt-4">
                                        <asp:LinkButton CommandArgument='<%# Eval("SourceCode") %>' OnClick="LinkButton1_Click" CssClass="btn btn-primary" ID="LinkButton1" runat="server"><i class="fa fa-download"></i>&nbsp;Download Source Code Now</asp:LinkButton>
                                    </div>
                                    <div class="left_img">
